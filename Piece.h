...
class Piece{
            ...
            //for(unsigned i = 0; i < pieces.size(); i++){
                //if(pieces.at(i) == this){
                    ...
                    if(isEnPassant(pieces, enPassantOldPosition, newPosition)){
                        int add = 1;
                        if(piece->getInformation()[0] == 'B') add = -1;
    ...
    private:
        ...
        //virtual vector<string> legalMovesRestrictedByCheck(vector<Piece*>& pieces, vector<string>& previousMoves, bool whiteTurn, bool& isInCheck);
        ...
        //                     //here, we capture that piece and now we need to recheck whether it keeps the king in check

        //                         if(pieces.at(i)->getInformation()[1] == 'K' && pieces.at(i)->getInformation()[0] == kingValue[0]){
        //                             //cout << "Made it in here\n";
        //                             //cout << "Front of piecesCapturedCheck: " << pieces.at(piecesCapturedCheck.front())->getPos() << endl;
        //                             kingPosition = pieces.at(piecesCapturedCheck.front())->getPos();
        //                             Piece* tempPiece = pieces.at(piecesCapturedCheck.front());
        //                             //pieces.erase(pieces.begin() + piecesCapturedCheck.front());
        //                             for(int e = 0; e < legalMoves.size(); e++){
        //                                 //cout << "Legal Moves at e: " << legalMoves.at(e) << endl;
        ...
        //                                             tempPieces.erase(tempPieces.begin() + piecesCapturedCheck.front());
        //                                             vector<string> moves = pieces.at(h)->temporaryLegalMoves(tempPieces, previousMoves, whiteTurn, isInCheck);
        ...
        //                                                     cout << "king pos: " << kingPosition << "  piece removing: " << pieces.at(i)->getInformation() << endl;
        ...
        //                                 }
        //                             }
        //                             //pieces.insert(pieces.begin() + piecesCapturedCheck.front(), tempPiece);
        //                         }
